// dating_feed_page.dart
//
// หน้า Home Feed สไตล์ TikTok สำหรับแอปหาคู่ (mock data ทั้งหมด, ไม่มี backend จริง)
// คัดลอกไฟล์นี้ไปไว้ใน lib/ ของโปรเจ็กแล้ว import `DatingFeedPage` ไปใช้ได้เลย
//
// วิธีทดสอบไฟล์นี้แบบเดี่ยว ๆ:
//   flutter run -t lib/dating_feed_page.dart
// (ถ้านำไปรวมกับโปรเจ็กที่มี main() อยู่แล้ว ให้ลบฟังก์ชัน main()
//  และคลาส _DemoApp ด้านล่างนี้ออก แล้วเรียกใช้ DatingFeedPage() ในแอปของคุณแทน)
...
class _DatingFeedPageState extends State<DatingFeedPage> {
  ...
  void _openChatPlaceholder(UserProfile profile) {
    ScaffoldMessenger.of(context).showSnackBar(
